...
export default function Bootstraploja() {
  ...
  <Row>
    ...
    <Col xs={{ order: 'last' }}><img
      ...
      <h4> <BsFillCartFill /><a class="link-secondary" href="#">Camiseta masculina R$99,99</a></h4></Col>
    <Col xs={{order: 'second' }}><img
      ...
      alt="Second slide"></img>
        <h4><BsFillCartFill /><a class="link-secondary" href="#">Blusa Corta-vento R$120,00</a></h4></Col>
    <Col xs={{ order: 'first' }}><img
      ...
      alt="Second slide"></img>
      <h4><BsFillCartFill /><a class="link-secondary" href="#">Blusa Feminina R$120,00</a></h4></Col>
      <Col xs={{ order: 'last' }}><img
      className="col-md-4.service-box"
      width={300}
      src="https://cf.shopee.com.br/file/41d0cd4bfbda27b2ea0358618a66aa6d"
      alt="Second slide"></img>
      <h4><BsFillCartFill /><a class="link-secondary" href="#">Conjunto moletom R$199,99</a></h4></Col>
      <Col xs={{ order: 'last' }}><img
      className="col-md-4.service-box"
      width={300}
      src="https://rogerstenis.vteximg.com.br/arquivos/ids/2724078-505-505/1000878343_1.jpg?v=637426897391870000"
      alt="Second slide"></img>
      <h4><BsFillCartFill /><a class="link-secondary" href="#">Camiseta feminina R$99,99</a></h4></Col>
      <Col xs={{ order: 'last' }}><img
      className="col-md-4.service-box"
      width={300}
      src="https://images.lojanike.com.br/1024x1024/produto/camiseta-manga-curta-sccp-m-nk-brt-strk-CQ4710-010-1.jpg"
      alt="Second slide"></img>
      <h4><BsFillCartFill /><a class="link-secondary" href="#">Regata treino R$129,99</a></h4></Col>
  </Row>
</Container>
